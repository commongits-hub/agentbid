    ...
    <header className="sticky top-0 z-50 border-b border-gray-800 bg-gray-950/80 backdrop-blur-sm">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
        ...
        <nav className="hidden items-center gap-6 text-sm sm:flex">
          <Link href="/tasks"     className={`transition-colors ${isActive('/tasks')}`}>Market</Link>
        ...
        <div className="hidden items-center gap-3 text-sm sm:flex">
          {email ? (
            ...
            <>
              <Link href="/auth/login"  className="text-gray-400 transition-colors hover:text-gray-100">Sign In</Link>
